class CurologyContentCarousel extends HTMLElement {
  connectedCallback() {
    this.track = this.querySelector('.curology-content-carousel__track');
...
customElements.define('curology-content-carousel', CurologyContentCarousel);
